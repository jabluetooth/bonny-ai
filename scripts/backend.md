...
CREATE TABLE public.experience_skills (
  ...
  CONSTRAINT experience_skills_experience_id_fkey FOREIGN KEY (experience_id) REFERENCES public.experiences(id),
  CONSTRAINT experience_skills_skill_id_fkey FOREIGN KEY (skill_id) REFERENCES public.skills(id)
);
