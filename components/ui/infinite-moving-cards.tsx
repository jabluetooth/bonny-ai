    ...
    return (
        ...
        >
            ...
            >
                {items.map((item, idx) => (
                    <li
                        className="w-[280px] max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-slate-700 p-6 md:w-[320px] min-h-[200px] bg-gradient-to-b from-slate-800 to-slate-900"
                        key={item.name + idx}
                    >
                        <blockquote>
                            <div
